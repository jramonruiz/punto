...
{
  var esnumero=document.frm_nueva_venta.txtpago_venta.value;
  tecla = (document.all) ? e.keyCode : e.which;
  if (tecla==13)
  	{	
  		if(isNaN(esnumero))
  		{
  			alert("Debe capturar cantidad NO LETRAS");
  			document.frm_nueva_venta.txtpago_venta.value=0;
  		}
  		else
  			{
				var totalpagar=document.frm_nueva_venta.txttotalpagar.value;
				...
				else if(txtpago_venta<totalpagar)
					{
						alert("La cantidad capturada debe ser igual o mayor que el TOTAL DE LA VENTA");
					}
				else
					{
...
{
  var esnumero=document.frm_datos_devolucion.txtpago_venta.value;
  tecla = (document.all) ? e.keyCode : e.which;
  if (tecla==13)
  	{	
  		if(isNaN(esnumero))
  		{
  			alert("Debe capturar cantidad NO LETRAS");
  			document.frm_datos_devolucion.txtpago_venta.value=0;
  		}
  		else
  		{
				...
				/*else if(txtpago_venta==diferencia)
					{
						alert("La cantidad capturada debe ser igual a la DIFERENCIA");
					}*/	
				else
					{
  ...
  if (tecla==13)
  	{
  		...
  		{
  			alert("Debe capturar cantidad NO LETRAS");
  			document.frm_nuevo_actualizacion_inventario.txtid_producto.value=0;
			document.frm_nuevo_actualizacion_inventario.txtcantidad_producto.value=0;
  		}
  		else
  		{
				//alert ('Has pulsado enter');
...
function cantidad_producto_buscadomod(e) {
	//alert("entro a cantidad_producto_buscadomod");
  tecla = (document.all) ? e.keyCode : e.which;
  if (tecla==13)
  	{
		//alert ('Has pulsado enter');
