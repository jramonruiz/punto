...
function cuentascobrarcliente(id_cliente)
{
	var id_cliente=id_cliente;
	//location.href = location.href + '?var1=32&var2=10';
	document.location.href ="cuentascobrarcliente.php"+'?idcliente='+id_cliente;	
}
...
function recargar_div()
{
	$("#central").load('../ventas/cargar_productos_vendidos.php');
}

 function tipo_operacion()
{
  var tipo_operacion==document.frm_nueva_venta.cmbtipo_operacion.value;
